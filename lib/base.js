...
var PointNeighborhood = (function() {
    ...
    var diagonal = [
        {dir: Direction.NORTHEAST, x: 1, y: 1},
        {dir: Direction.NORTHWEST, x: -1, y: 1},
        {dir: Direction.SOUTHEAST, x: 1, y: -1},
        {dir: Direction.SOUTHWEST, x: -1, y: -1}
    ];

    var neighborTypes = {
        adjacent: adjacent,
        diagonal: diagonal,
        around: _.concat(adjacent, diagonal)
    };
    ...
    var _PointNeighborhood = function(referencePoint) {
        ...
        this.adjacent = function(callback) {
            return getNeighbors('adjacent', this.referencePoint, callback);
        };
