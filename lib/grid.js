...
var GridFill = (function() {
    // o ponto inicial escolhido assume a missao de espalhar o novo valor
    // apenas para os iguais a ele
    // pega vizinhos que sao:
    //      iguais ao ponto atual (startPoint)
    //
    ...
    var _GridFill = function(baseGrid, startPoint, newValue) {
        ...
        this.step = function() {
            ...
            for (var i = fillStartIndex; i <= fillEndIndex; i++) {
                var neighbors, point = this.points[i];
        ...
        this.region = function() {
            //var region;
            while(this.fillStartIndex != this.points.length) {
                this.step();
            }
            return this.points;
        };
...
var g = Grid.new(10, 10, 0);
var r = GridFill.new(g, Point.new(5,5), 1)
r.step();