...
var GridFill = (function() {
    var _GridFill = function (grid, fillValue, callback, edgeCallback) {
        var self = this,
            ...
            neighbors.adjacent(function(neighbor) {
                ...
                if (canBeFilled(neighbor)) {
                    if (isPartial && ! shouldFill()) {
                        ...
                        fillPoint(neighbor);
                        callback(neighbor, fillValue);
                        _seeds.add(neighbor);
                    }
                } else {
                    _edges.add(referencePoint);
                    edgeCallback(referencePoint);
                }
            });
        };
    ...
    return {
        new: function(grid, fillValue, callback, edgeCallback) {
            return new _GridFill(grid, fillValue, callback, edgeCallback);
        }
    };
})();
