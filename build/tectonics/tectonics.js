...
var TectonicsBuilder = function TectonicsBuilder(world, numPlates) {
...
var Tectonics = function Tectonics(size) {
  var self = this;
...
var PlateDeformation = function () {
  var _PlateDeformation = function _PlateDeformation(plate) {
    var self = this,
  ...
  return {
    new: function _new(target_plate) {
