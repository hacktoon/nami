...
var Direction = (function(){
    ...
    var buildEnumInterface = function(base){
        _.each(directionMap, function(obj, key){
            base[key] = obj.code;
        });
        return base;
    };
    ...
    return buildEnumInterface({
        getName: function(code) {
            for(var name in directionMap) {
                var dir = directionMap[name];
                if (code === dir.code) {
                    return name
                }
            };
        ...
        isDivergent: function (direction, other) {
            return direction * -1 === other;
        },

        isConvergent: function (direction, other) {
            return direction * -1 === other;
        },
