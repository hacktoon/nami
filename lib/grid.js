...
var GridFill = (function() {
    var _GridFill = function(baseGrid, startPoint, newValue) {
        ...
        this.grow = function() {
            ...
            fillQueue.forEach(function(point){
                var neighborPoints = growNeighbors(point);
                edges = _.concat(edges, neighborPoints);
            });
        ...
        var growNeighbors = function(point) {
            ...
            Point.neighborHood(point, 'axials', function(neighborPoint) {
                if (self.isPointFilled(neighborPoint)) return;
