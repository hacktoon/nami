...
var shuffleGrid = function shuffleGrid(grid, values) {
...
var step = function step(grid) {
  ...
  grid.forEach(function (value, point) {
    var neighborhood = new PointNeighborhood(point),
        neighbours = count_one = count_zero = 0;
...
var draw = function draw(grid, valueMap) {
