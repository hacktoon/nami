...
var HeightMap = (function(){
    var _HeightMap = function (size, roughness){
        ...
        this.setPoint = function (point, height) {
        ...
        var setInitialPoints = function() {
            var rand = function(){ return _.sample([0, size]); }
            self.setPoint(Point.new(0, 0), rand());
            self.setPoint(Point.new(size-1, 0), rand());
            self.setPoint(Point.new(0, size-1), rand());
            self.setPoint(Point.new(size-1, size-1), rand());
        };
        ...
        var diamond = function (point, midSize, offset){
            ...
            self.setPoint(point, average + offset);
        };
