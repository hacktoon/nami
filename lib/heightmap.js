...
var HeightMap = function(gridSize, maxHeight, roughness, opts){
    var opts = _.assign({
            callback: function(){}
        }, opts),
        gridSize = gridSize + 1,
    ...
    var setPointHeight = function(point, height){
        var height = _.clamp(height, 0, maxHeight);
    ...
    setPointHeight(Point.new(0, 0), 0);
    setPointHeight(Point.new(grid.width-1, 0), 0);
    setPointHeight(Point.new(0, grid.height-1), 0);
    setPointHeight(Point.new(grid.width-1, grid.height-1), 0);
