...
var Grid = (function(){
    var _Grid = function(){
        ...
        this.randomPoints = function(numPoints) {
            ...
            while(true){
                ...
                var point = createRandomPoint(),
                    hash = point.hash(),
                    minDistance = (self.width * 2) / numPoints,
                    isMinDistance = hasMinimumDistance(point, chosenPoints, minDistance);
        ...
        var hasMinimumDistance = function(point, points, minDistance){
